...
| 19 | `[SHOP] pads drawn` | pad visuals created at the horn — proves draw-time code ran while clients were connected (spec 013 visibility fix) | `Marker.shopPadsDrawn` |
